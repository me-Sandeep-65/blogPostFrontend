...
function GoogleLoginButton() {
  ...
  return (
    <ButtonOutlined tailwindClasses="w-4/5" text="Sign in with Google" iconElement={<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 48 48">
...
</svg>} iconWidth="w-1/12" onClick={googleLoginHandler} ></ButtonOutlined>
  )
}
